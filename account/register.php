					...
					<div class="row align-items-center justify-content-center">
						...
						<div class="col-md-12 col-lg-6 login-right">
							...
							<div class="login-header">
								<h3>Registro <a href="doctor-register.php">Você é um profissional?</a></h3>
							</div>
							
							<!-- Register Form -->
							<form method="post" action="../app/controllers/userController.php?function=registrar_paciente">
