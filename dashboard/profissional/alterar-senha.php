				...
				<div class="card">
					<div class="card-body">
						<div class="col-md-12 col-lg-6">
							...
							<form id="resetasenha" method="post" action="../../app/controllers/profissionalController.php?function=update_senha_profissional">
...
<script>
	...
	$(document).on('submit','#resetasenha',function(event){
        ...
        $.ajax({
            url: '../../app/controllers/profissionalController.php?function=update_senha_profissional',
            method: 'post',
            dataType: 'html',
            data: dados,
