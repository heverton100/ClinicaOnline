							...
							<div class="card">
								<div class="card-body">
									<div class="col-md-12 col-lg-6">
										...
										<form id="resetasenha" method="post" action="../../content/controllers/sisController.php?function=updatesenha">
		...
		<script>
			...
			$(document).on('submit','#resetasenha',function(event){
		        ...
		        $.ajax({
		            url: '../../content/controllers/sisController.php?function=updatesenha',
		            method: 'post',
		            dataType: 'html',
		            data: dados,
