...
require_once '../../content/dao/daoPaciente.php';

$teste = new daoPaciente;

$result = $teste->retornaPaciente($_SESSION['IDPACIENTE']);
...
?>
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="card">
								<div class="card-body">
									...
									<form id="cadpacienteimage" method="post" action="../../content/controllers/pacienteController.php?form=cadpacienteimage">
									...
									<form id="cadpaciente" method="post" action="../../content/controllers/pacienteController.php?form=cadpaciente">	
										<div class="row form-row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label>Name</label>
		...
		<script type="text/javascript">
			...
			$("#imagep").change(function(event) {
		        ...
		        $.ajax({
		            url: '../../content/controllers/pacienteController.php?form=cadpacienteimage',
	              	type: 'post',
	              	data: fd,
	              	contentType: false,
	              	processData: false,
			...
			$(document).on('submit','#cadpaciente',function(event){
		        ...
		        $.ajax({
		            url: '../../content/controllers/pacienteController.php?form=cadpaciente',
		            method: 'post',
		            dataType: 'html',
		            data: dados,
		            success: function(data){
