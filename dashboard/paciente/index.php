								...
								<div class="card-body pt-0">
									...
									<nav class="user-tabs mb-4">
										<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
											<li class="nav-item">
												<a class="nav-link active" href="#pat_appointments" data-toggle="tab">Agendamentos</a>
											</li>
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Dr. Jefferey Candelaria <span>Dental</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Dr. Cerys Fleming <span>Orthopaedics</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Dr. Deniece Wiles <span>Dental</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Dr. Jefferey Candelaria <span>Ophthalmology</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
		...
		<script type="text/javascript">
			...
			$.post("../../content/controllers/pacienteController.php?form=retornaAgendamentos", 
			{
