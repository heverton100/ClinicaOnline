<?php
session_start();
if (isset($_SESSION['email_user']) || isset($_SESSION['IDPACIENTE'])) {
					...
					<div class="row align-items-center justify-content-center">
						...
						<div class="col-md-12 col-lg-6 login-right">
							...
							<div class="login-header">
								<h3>Registro <a href="../public/registro_profissional">Você é um profissional?</a></h3>
							</div>
							
							<!-- Register Form -->
							<form method="post" action="../app/controller/HandlerUsuario.php?function=registrar_paciente">
								...
								<button class="btn btn-primary btn-block btn-lg login-btn" id="registrar" type="submit">Registrar</button>
							</form>
							<!-- /Register Form -->
