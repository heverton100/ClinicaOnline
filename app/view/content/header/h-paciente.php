				...
				<ul class="nav header-navbar-rht">
					...
					<li class="nav-item dropdown has-arrow logged-item">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img">
								<img class="rounded-circle" src="<?php echo $_SESSION['URLFOTO']; ?>" width="31">
							</span>
						</a>
						<div class="dropdown-menu dropdown-menu-right">
							...
							<a class="dropdown-item" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/clinica/clinicanova/app/view/dashboard/paciente/index.php">Minha Conta</a>
