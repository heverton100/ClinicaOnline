												...
												<div class="schedule-header">
													...
													<div class="schedule-nav">
														<ul class="nav nav-tabs nav-justified">
															<li class="nav-item">
																<a class="nav-link active" onclick="funGetDay(1)" data-toggle="tab" href="#slot_sunday">Domingo</a>
															</li>
															<li class="nav-item">
																<a id="primeiro" class="nav-link" onclick="funGetDay(2)" data-toggle="tab" href="#slot_monday">Segunda</a>
															</li>
															<li class="nav-item">
												...
												<div class="tab-content schedule-cont">
													...
													<div id="slot_sunday" class="tab-pane fade">
														<h4 class="card-title d-flex justify-content-between">
															...
															<a class="edit-link" data-toggle="modal" href="#add_time_slot"><i class="fa fa-plus-circle"></i> Inserir</a>
														</h4>
														<div id="retorno1"></div>
													</div>
													<!-- /Sunday Slot -->
													...
													<div id="slot_monday" class="tab-pane fade">
														<h4 class="card-title d-flex justify-content-between">
															<span>Disponibilidade</span> 
															<a class="edit-link" data-toggle="modal" href="#add_time_slot"><i class="fa fa fa-plus-circle"></i> Inserir</a>
														</h4>
														<div id="retorno2"></div>
													</div>
													<!-- /Monday Slot -->
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Adicionar Horário Disponível</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form id="novoTimeSlot" method="post" action="../../content/controllers/profissional/scheduleController.php?function=novo_timeslot">
								...
								<div class="row form-row">
									<div class="col-12 col-md-6">
										<div class="form-group">
											...
											<select id="horainicial" name="horainicial" class="form-control horarios"></select>
										</div> 
									</div>
									<div class="col-12 col-md-6">
										<div class="form-group">
											<label>Hora Final</label>
											<select id="horafinal" name="horafinal" class="form-control horarios"></select>
										</div> 
									</div>
								</div>
							</div>
...
<script>
	...
	$.post("../../app/controllers/horariosController.php?function=retorna_horarios",
	...
	function funGetDay(teste) {
		...
		$.post("../../app/controllers/horariosController.php?function=retorna_horarios_dia",
	...
	$(document).on('submit','#novoTimeSlot',function(event){
        ...
        $.ajax({
            url: '../../app/controllers/horariosController.php?function=novo_timeslot',
            method: 'post',
            dataType: 'html',
            data: dados,
	...
	function funDeletarHorario(idHorario,dia) {
		...
		$.post("../../app/controllers/horariosController.php?function=deleta_horario",
		{id: idHorario}, 
		function(result){
			funGetDay(dia);
		});
