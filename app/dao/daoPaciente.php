...
class daoPaciente{
	...
	public function retorna_agendamentos($id){
		...
		$query = "SELECT AGE.*, PRO.nome AS NOMEPRO, PRO.url_foto AS FOTOPRO FROM tbl_agendamento AGE 
		INNER JOIN tbl_profissional PRO ON PRO.ID_PROFISSIONAL = AGE.ID_PROFISSIONAL 
		WHERE AGE.ID_PACIENTE = $id";
	...
	public function retorna_paciente($id){
	...
	public function atualiza_endereco($logradouro,$numero,$estado,$cidade,$bairro,$complemento,$pais,$cep,$id){
	...
	public function update_senha_paciente($id,$senhaantiga,$senhanova){
